...
#norm_images, norm_labels = load_normal('../PneumoniaDetectionAI/chest_xray/train/NORMAL/IM-0001-0001.jpg')
#pneu_images, pneu_labels = load_pneumonia('../PneumoniaDetectionAI/chest_xray/train/PNEUMONIA/')
...
norm_images_test, norm_labels_test = load_normal('../PneumoniaDetectionAI/chest_xray/test/NORMAL/IM-0001-0001.jpeg')
pneu_images_test, pneu_labels_test = load_pneumonia('../PneumoniaDetectionAI/chest_xray/test/PNEUMONIA/IM-0001-0001')
...
#new_model = tf.keras.models.load_model('pneumonia_cnn.h5')
